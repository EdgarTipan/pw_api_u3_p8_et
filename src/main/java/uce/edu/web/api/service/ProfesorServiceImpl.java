...
public class ProfesorServiceImpl implements IProfesorService {
    ...
    public ProfesorTo buscarPorId(Integer id, UriInfo uriInfo) {
        ...
        ProfesorTo p = new ProfesorTo(p1.getId(), p1.getNombre(), p1.getApellido(), p1.getFechaNacimiento(),
                p1.getSueldo(), uriInfo);
        return p;
    }

    @Override
    public List<Profesor> buscarTodos(Float sueldo) {
        return this.profesorRepo.seleccionarTodos(sueldo);
    }
